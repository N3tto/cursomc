...
import com.neto.cursomc.cursomc.domain.Cidade;
...
import com.neto.cursomc.cursomc.domain.Pedido;
import com.neto.cursomc.cursomc.domain.Produto;
import com.neto.cursomc.cursomc.domain.enums.EstadoPagamento;
import com.neto.cursomc.cursomc.domain.enums.TipoCliente;
import com.neto.cursomc.cursomc.repositories.CategoriaRepository;
import com.neto.cursomc.cursomc.repositories.CidadeRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		categoriaResporitory.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7));
